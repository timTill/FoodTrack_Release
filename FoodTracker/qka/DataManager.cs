...
namespace FoodTracker.Models
{
	...
	{
		const string XMLinPath = @"C:\Users\Szabolcs\Source\Repos\FoodTracker\FoodTracker\FoodTracker\Port\DataToImport.xml";
		const string XMLoutPath = @"C:\Users\Szabolcs\Source\Repos\FoodTracker\FoodTracker\FoodTracker\Port\DataToDB.xml";
		...
		/*
		public void stdOutXML(PortDBViewModel DB_VM)
		{
		...
		*/
		...
		public PortDBViewModel normalizeIDs(PortDBViewModel input)
		{
		...
		/*
		public void AddManyCategoriesFromParamToDBTest(IEnumerable<Category> categList)
		{
		...
		public void AddManySubCategoriesFromParamToDBTest(IEnumerable<SubCategory> subcategList)
		{
			using (var context = new ApplicationDbContext())
			{
